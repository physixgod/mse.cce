...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCE.Domain.Usine.Entities.ProductionPotentielle", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<long?>("CadenceNominale")
                        .HasColumnType("bigint");

                    b.Property<string>("CodeLigne")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CodeLigne");

                    b.ToTable("ProductionPotentielles");
                });
            ...
            modelBuilder.Entity("CCE.Domain.Usine.Entities.ProductionPotentielle", b =>
                {
                    b.HasOne("CCE.Domain.Usine.Entities.Ligne", "Ligne")
                        .WithMany("ProductionPotentielles")
                        .HasForeignKey("CodeLigne")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CCE.Domain.Usine.Entities.Ligne", b =>
                {
                    b.Navigation("ProductionPotentielles");
                });
